  ...
  return (
    <div className="fixed w-screen h-screen top-0 left-0 bg-[#3339] flex justify-center items-center">
        <div className="max-w-80 w-full flex flex-col gap-3">
            ...
            <button className="w-full block" onClick={showCroppedImage}>Upload</button>  
            <button className="w-full block bg-block text-foreground" onClick={handleCancel}>Cancel</button> 
        </div>
