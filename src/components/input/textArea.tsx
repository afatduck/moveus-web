...
function TextArea ({validate, value, setValue, name, label, placeholder, onChange, className, rows, cols }: TextAreaProps) {
    ...
    return <label htmlFor={id} className={className}>
        ...
        <textarea name={name} id={id} placeholder={placeholder} rows={rows} cols={cols}
