...
function TextInput ({validate, value, setValue, name, label, placeholder, onBlur, onChange, className, type = "text"}: TextInputProps) {
    ...
    return <label htmlFor={id} className={className}>
        ...
        <input type={type} name={name} id={id} placeholder={placeholder} onBlur={onBlur}
        value={value} onChange={handleChange} className={error && '!border-error !outline-error'}/>
