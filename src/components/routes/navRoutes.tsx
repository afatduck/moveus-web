...
import { HiHome, HiChatBubbleLeftRight, HiGlobeEuropeAfrica, HiUserCircle, HiOutlinePlus } from 'react-icons/hi2'
            ...
            <nav className="bg-accent w-screen absolute left-0 ">
                <div className="flex items-center justify-around text-4xl text-background h-full max-w-96 mx-auto text-center">
                    ...
                    <Link to='/feed' className="block">
                        <HiGlobeEuropeAfrica className={pathname === '/feed' ? "text-block-accent" : ""} />
                    ...
                    <Link to='/profile' className="block">
                        <HiUserCircle className={pathname === '/profile' ? "text-block-accent" : ""} />
