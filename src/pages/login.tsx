...
import { ContextProfileFragment, useLoginUserMutation } from "~/graphql/generated"
    ...
    return (
        <div className="container-center">
            ...
            <form className="block w-full" onSubmit={handleSubmit}>
                <TextInput name="user" placeholder="username/email" setValue={setUser}
                    value={user} label="Username or email" />
